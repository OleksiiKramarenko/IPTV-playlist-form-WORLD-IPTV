...
EXCLUDE_KEYWORDS = [
    # Технические / мусор
    "vpn", "play-x", "торрент тв", "test", "удалить",
    "nexo", "olsib", "nnt", "бегет", "сириус", "turon", "евразия-стар",
    "catcast", "claruty", "cloudflare", "webhost", "agronet", "инфолинк",
    "тт мобайл", "кухня", "селектел", "цитадель", "квант-телеком",
    # Страны и регионы
    "австралия", "australia",
    "азербайджан", "azerbaijan", "азери", "азери",
    "армения", "հայկական",
    "арабские", "arabic", "arab", "islam",
    "беларусь", "белорусские",
    "болгария", "bulgaria",
    "бразилия", "brasil",
    "великобритания", "united kingdom",
    "венгрия", "hungary",
    "германия", "germany", "deutsch",
    "грузия", "georgia",
    "дания", "denmark",
    "египет", "egypt",
    "израиль", "israel",
    ...
    "испания", "spain",
    "италия", "italy",
    "казахстан", "казахские", "казахстанские",
    "канада", "canada",
    "корея", "korea",
    "кыргызстан",
    "латвия", "latvia",
    ...
    "татарстан",
    "туркменистан",
    "турецкие", "турция", "turkish", "türk",
    "узбекистан", "узбекские", "uzbekistan", "itv.uz",
    "финляндия", "finland",
    "франция", "france",
    "хорватия", "croatia",
    "чехия", "czech",
    ...
    "эстония", "estonia",
    "европа", "europe",
    "baltic", "russian", "россия",
    # Категории
    "новост", "региональн", "телемагазин",
    "киноконцерн", "киноновел", "сделано в ссср",
    "радио",
]
# ─────────────────────────────────────────────────────────────────────────────
...
def is_excluded(meta: str) -> bool:
    """Вернуть True если group-title содержит любое из ключевых слов"""
